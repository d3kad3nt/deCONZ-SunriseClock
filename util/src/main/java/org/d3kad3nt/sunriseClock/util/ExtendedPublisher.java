...
public class ExtendedPublisher<T> implements Flow.Publisher<T> {
    ...
    /**
     * This class implements the java Flow.Publisher API. It has public methods to publish new values and indicate that
     * all values are sent.
     *
     * @param cache_publish_values This indicates if all published values should be cached until the next complete call
     *     If the values are cached they are emitted to each subscriber that was added after the value was published but
     *     before complete was called
     */
