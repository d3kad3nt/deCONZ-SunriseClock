...
@Dao
public interface LightRemoteUnswitchableUndimmableUntemperaturableColorableDao extends LightBaseDao<LightRemote_SwitchableUndimmableUntemperaturableUncolorable> {
