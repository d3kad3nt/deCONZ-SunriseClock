...
@Dao
public interface LightRemoteUnswitchableUndimmableUntemperaturableColorableDao extends BaseLightDao<LightRemote_SwitchableUndimmableUntemperaturableUncolorable> {
