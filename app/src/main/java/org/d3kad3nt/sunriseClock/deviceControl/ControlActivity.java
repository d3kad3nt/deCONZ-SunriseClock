...
/**
 * This Activity is used for the Device Control Service. A own service for this is needed, because
 * it uses a own navgraph and a own fragment for the activity without a drawer.
 *
 * <p>It is possible that this can also be archived purely by using Navigation functions, but i
...
public class ControlActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        navController.setGraph(
                R.navigation.nav_graph_device_control, getIntent().getExtras());
