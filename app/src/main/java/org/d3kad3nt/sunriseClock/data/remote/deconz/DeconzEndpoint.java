...
public class DeconzEndpoint extends BaseEndpoint {
  ...
  /**
   * From the Deconz rest api documentation: "An 'all' group is generated by the REST API by default
   * with all lights in it. This group is available at '/api/groups/0' but this id is not always 0.
  ...
  public DeconzEndpoint init() {
    ...
    Gson gson =
        new GsonBuilder()
            ...
            .registerTypeAdapter(
                remoteLightListType,
                new RemoteLightListTypeAdapter(super.getOriginalEndpointConfig().getId()))
            .create();
