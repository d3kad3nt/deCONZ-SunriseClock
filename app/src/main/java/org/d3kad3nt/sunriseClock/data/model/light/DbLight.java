...
public class DbLight extends DbEndpointEntity {
    ...
    public DbLight(
            long endpointId,
            @NonNull String endpointEntityId,
            @NonNull String name,
    ...
    public boolean equals(final Object o) {
        ...
        return super.equals(dbLight)
                && (isSwitchable == dbLight.isSwitchable
                        && isOn == dbLight.isOn
                        && isDimmable == dbLight.isDimmable
                        && brightness == dbLight.brightness
                        && isTemperaturable == dbLight.isTemperaturable
                        && colorTemperature == dbLight.colorTemperature
                        && isColorable == dbLight.isColorable
                        && color == dbLight.color
                        && isReachable == dbLight.isReachable);
    }
