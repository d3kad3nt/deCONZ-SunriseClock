...
public class DbLightBuilder {
  ...
  /**
   * @param endpointId Foreign key (Room/SQLite) of the remote endpoint that this light belongs to.
  ...
  /**
   * @param isSwitchable Whether the light's capabilities allow it to be turned on and off (true if
  ...
  /**
   * @param brightness The current brightness of the light, where 0 is the lowest brightness or off
