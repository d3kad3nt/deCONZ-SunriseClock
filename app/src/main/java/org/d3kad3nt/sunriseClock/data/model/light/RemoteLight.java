...
public class RemoteLight {
    ...
    static DbLight toDbLight(RemoteLight remoteLight) {
        ...
        DbLight dbLight = dbLightBuilder.setEndpointId(remoteLight.getEndpointId()).setEndpointLightId(remoteLight.getEndpointLightId()).setName(remoteLight.getName()).setIsSwitchable(remoteLight.getIsSwitchable()).setIsOn(remoteLight.getIsOn()).setIsDimmable(remoteLight.getIsDimmable())
                ...
                .setBrightness((((remoteLight.getBrightness() - remoteLight.getEndpointType().getMinBrightness()) * (DbLight.BRIGHTNESS_MAX - DbLight.BRIGHTNESS_MIN)) / (remoteLight.getEndpointType().getMaxBrightness() - remoteLight.getEndpointType().getMinBrightness())) + DbLight.BRIGHTNESS_MIN).setIsTemperaturable(remoteLight.getIsTemperaturable()).setColorTemperature(remoteLight.getColorTemperature()) //Todo: Implement
                // conversion
                .setIsColorable(remoteLight.getIsColorable()).setColor(remoteLight.getColor()) //Todo: Implement conversion
                .build();
