...
public interface DbLightDao {
     ...
     * the database.<br>
     * Case 2: <br>
     * Update if lightId (primary key) is given in the light object. A light with this lightId must
     * already exist inside the database. <br>
     * Case 3: <br>
     * Update if endpointId and endpointLightId are given in the light object. A light with this
    ...
    default void upsert(DbLight obj) {
        ...
        // The lightId primary key is autogenerated by room, therefore it is not known to the remote
        // endpoint.
        else if (obj.getEndpointId() != 0L && !(obj.getEndpointLightId().equals(""))) {
            int rowsUpdated = updateUsingEndpointIdAndEndpointLightId(
                    obj.getEndpointId(),
