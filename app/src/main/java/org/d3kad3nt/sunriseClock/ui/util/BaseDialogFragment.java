...
// 1.: Override onCreateDialog() and use the MaterialAlertDialogBuilder to define the layout (including buttons and
...
public abstract class BaseDialogFragment<DataBindingT extends ViewDataBinding, ViewModelT extends ViewModel> extends DialogFragment {
    ...
    public View onCreateView(@NonNull final LayoutInflater inflater, @Nullable final ViewGroup container,
        ...
        // Google: The view returned by onCreateView() is automatically added to the dialog. In most cases,
        // this means that we don't need to override onCreateDialog(), as the default empty dialog is populated with
        // our view.
        return binding.getRoot();
    }

    // onViewCreated() is only called because we've overridden onCreateView() and provided a non-null view.
    @Override
