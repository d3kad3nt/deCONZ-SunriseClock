...
public class EndpointManagementViewModel extends ViewModel {
    ...
    static final ViewModelInitializer<EndpointManagementViewModel> initializer =
            new ViewModelInitializer<>(EndpointManagementViewModel.class, creationExtras -> {
                ...
                return new EndpointManagementViewModel(endpointRepository, settingsRepository, endpointId);
            });
    ...
    public EndpointManagementViewModel(
