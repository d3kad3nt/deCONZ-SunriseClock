...
public class EndpointsOverviewListAdapter
        extends ListAdapter<IEndpointUI, EndpointsOverviewListAdapter.EndpointListViewHolder> {

    private final EndpointsOverviewViewModel viewModel;
    private final ClickListeners clickListeners;

    public EndpointsOverviewListAdapter(
            final EndpointsOverviewViewModel viewModel, final ClickListeners clickListeners) {
