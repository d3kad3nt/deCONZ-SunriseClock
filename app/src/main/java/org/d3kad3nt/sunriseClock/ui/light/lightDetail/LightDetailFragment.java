...
public class LightDetailFragment extends Fragment implements MenuProvider {
  ...
  public View onCreateView(
    ...
    long lightID =
        LightDetailFragmentArgs.fromBundle(requireArguments()).getLight(); // id from navigation
  ...
  public boolean onMenuItemSelected(@NonNull final MenuItem menuItem) {
    ...
    // Instead, a menu item should be provided to allow refresh of the content wherever this gesture
    // is used.
    if (menuItem.getItemId() == R.id.menu_light_details_refresh) {
      ...
      Navigation.findNavController(binding.getRoot())
          .navigate(
              LightDetailFragmentDirections.actionLightDetailToLightDetailInfoDialogFragment());
      return true;
      ...
      Navigation.findNavController(binding.getRoot())
          .navigate(
              LightDetailFragmentDirections.actionLightDetailToLightDetailNameEditDialogFragment());
      return true;
    } else {
      return false;
    }
