...
public class MainSettingsFragment extends PreferenceFragmentCompat {
    ...
    public void onCreatePreferences(Bundle savedInstanceState, String rootKey) {
        ...
        Map<String, Integer> links = Map.of("pref_connectivity_category", R.id.action_mainSettingsFragment_to_connectivityFragment, "pref_alarm_category", R.id.action_mainSettingsFragment_to_alarmFragment, "pref_interface_category", R.id.action_mainSettingsFragment_to_interfaceFragment, "pref_debug_category", R.id.action_mainSettingsFragment_to_debugFragment);
