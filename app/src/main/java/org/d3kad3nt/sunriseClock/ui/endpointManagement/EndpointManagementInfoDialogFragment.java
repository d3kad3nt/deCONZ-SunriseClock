...
import org.d3kad3nt.sunriseClock.databinding.EndpointManagementInfoDialogFragmentBinding;
...
public class EndpointManagementInfoDialogFragment
        extends BaseDialogFragment<EndpointManagementInfoDialogFragmentBinding, EndpointManagementViewModel>
        implements DialogOkClickListener {

    @Override
    protected EndpointManagementInfoDialogFragmentBinding getViewBinding() {
        return EndpointManagementInfoDialogFragmentBinding.inflate(getLayoutInflater());
    }
