...
import org.d3kad3nt.sunriseClock.databinding.EntitiesListElementGroupBinding;
import org.d3kad3nt.sunriseClock.util.LogUtil;

public class EntitiesListAdapterGroup extends ListAdapter<UIGroup, EntitiesListAdapterGroup.GroupViewHolder> {

    private final ClickListeners clickListeners;

    public EntitiesListAdapterGroup(final ClickListeners clickListeners) {
    ...
    public class GroupViewHolder extends RecyclerView.ViewHolder {
        ...
        private final EntitiesListElementGroupBinding binding;

        GroupViewHolder(@NonNull EntitiesListElementGroupBinding binding) {
