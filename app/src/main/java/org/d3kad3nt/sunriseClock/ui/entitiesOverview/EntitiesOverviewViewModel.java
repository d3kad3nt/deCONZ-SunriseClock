...
public class EntitiesOverviewViewModel extends ViewModel {
    ...
    static final ViewModelInitializer<EntitiesOverviewViewModel> initializer =
            new ViewModelInitializer<>(EntitiesOverviewViewModel.class, creationExtras -> {
                ...
                return new EntitiesOverviewViewModel(lightRepository, settingsRepository);
            });
    ...
    public EntitiesOverviewViewModel(
            @NonNull LightRepository lightRepository, @NonNull SettingsRepository settingsRepository) {
        super();
